...
namespace _08_Selection
{
    class Program
    {
        ...
        {
            // 1. Try using different data types in the comparison
            // 2. Use Google to find out how to use an "else if" statement
            // 3. Print out grades for different mark levels
        }
